...
<head>
    ...
    <title>Login Page - KELOLA SISTEM SAMPAH UYP IOT</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    <img src="{{ asset('template/src/logo pasopati.png') }}" width="200px"
                                        alt="">
                                </a>

                                <h4 class="card-title" style="text-align: center">Welcome to Kelola Sampah IOT ! 👋
                                </h4>
