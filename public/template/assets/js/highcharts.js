...
(function () {
  ...
  y.numberFormat = function (a, b, c, d) {
    var e = S.lang,
      ...
      f =
        b === -1
          ? H((a.toString().split(".")[1] || "").length, 20)
          : isNaN((b = P(b)))
          ? 2
          : b,
  ...
  S = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/4.1.4/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/4.1.4/gfx/vml-radial-gradient.png",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 0,
    ...
    na = function (a) {
      ...
      (function (a) {
        a && a.stops
          ...
          : (c = Tb.exec(a)) && (b = [C(c[1]), C(c[2]), C(c[3]), 1]);
      })(a);
      return {
        get: function (c) {
          var f;
  ...
  L.prototype = {
    ...
    clip: function (a) {
      return this.attr(
        "clip-path",
        a ? "url(" + this.renderer.url + "#" + a.id + ")" : M
      );
    },
    crisp: function (a) {
      var b,
    ...
    getBBox: function (a) {
      ...
      d !== v &&
        ...
        (l =
          d === "" || Mb.test(d) ? "num:" + d.toString().length + l : d + l));
      l && !a && (b = c.cache[l]);
      if (!b) {
        ...
        if (c.isSVG) {
          ...
          if (ya && g && g.fontSize === "11px" && d.toPrecision(3) === "16.9")
            b.height = d = 14;
          if (e)
            (b.width = P(d * $(h)) + P(a * W(h))),
              (b.height = P(d * W(h)) + P(a * $(h)));
        }
        c.cache[l] = b;
      }
      return b;
  ...
  L.prototype["stroke-widthSetter"] = L.prototype.strokeSetter = function (
    a,
    b,
    c
  ) {
  ...
  ta.prototype = {
    ...
    init: function (a, b, c, d, e) {
      ...
      this.alignedObjects = [];
      this.url =
        (La || xb) && D.getElementsByTagName("base").length
          ? f.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(D.createTextNode("Created with Highcharts 4.1.4"));
    ...
    buildText: function (a) {
      for (
        var b = a.element,
          ...
          n = k && k.lineHeight,
          o = k && k.textShadow,
          s = k && k.textOverflow === "ellipsis",
          x = g.length,
          T = l && !a.added && this.box,
          B = function (a) {
            return n
              ? C(n)
              : c.fontMetrics(
        ...
        b.removeChild(g[x]);
      !f && !o && !s && e.indexOf(" ") === -1
        ? b.appendChild(D.createTextNode(u(e)))
        : ((h = /<.*style="([^"]+)".*>/),
          (i = /<.*href="(http[^"]+)".*>/),
          T && T.appendChild(b),
          (e = f
          ...
          m(e, function (e, f) {
            ...
            m(g, function (e) {
              if (e !== "" || g.length === 1) {
                ...
                i.test(e) &&
                  !d &&
                  (I(x, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                  J(x, { cursor: "pointer" }));
                e = u(e.replace(/<(.|\n)*?>/g, "") || " ");
                if (e !== " ") {
                  ...
                  !n &&
                    f &&
                    (!ba && d && J(x, { display: "block" }), I(x, "dy", B(x)));
                  if (l) {
                    for (
                        ...
                        s && r
                          ...
                          ? ((o = v),
                            ...
                            o.length &&
                              ...
                              b.appendChild(x)),
                            ua > l && (l = ua))
                          : (x.removeChild(x.firstChild), v.unshift(o.pop())),
                        o.length &&
                          x.appendChild(
                            D.createTextNode(o.join(" ").replace(/- /g, "-"))
                          );
    ...
    fontMetrics: function (a, b) {
      ...
      if (b && O.getComputedStyle)
        (b = b.element || b), (a = O.getComputedStyle(b, "").fontSize);
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
            ...
            (a = w(-B * u)),
              ...
              (o.box = x =
                d
                  ...
                  : n.rect(a, b, o.width, o.height, 0, E[Nb])),
              x.attr("fill", M).add(o);
      ...
      function k() {
        var a = o.styles,
          ...
          c;
        c = h ? 0 : H;
        if (r(fa) && p && (a === "center" || a === "right"))
          b += { center: 0.5, right: 1 }[a] * (fa - p.width);
        if (b !== s.x || c !== s.y)
          s.attr("x", b),
            c !== v &&
              s.attr(s.element.nodeName === "SPAN" ? "y" : "translateY", c);
        s.x = b;
        s.y = c;
      }
      function l(a, b) {
    ...
    var Na = {
      ...
      init: function (a, b, c, d) {
        ...
        d = this.createElement(Ka).css(
          q(this.getStyle(d), { position: "relative" })
        );
        e = d.element;
  ...
  Ta.prototype = {
    ...
    render: function (a, b, c) {
      ...
      if (n && B)
        r === "inside" && (B = -B),
          d.opposite && (B = -B),
          (h = this.getMarkPath(y, q, B, n * z, g, f)),
          o
            ? o.animate({ d: h, opacity: c })
            : (this.mark = f
                .path(h)
                .attr({ stroke: u, "stroke-width": n, opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(y))
        (i.xy = q = this.getLabelPosition(y, q, i, g, k, w, a, fa)),
          ...
          (this.isLast && !this.isFirst && !p(e.showLastLabel, 1))
            ...
            : g &&
              ...
              !b &&
              c !== 0 &&
              this.handleOverflow(q),
          fa && a % fa && (t = !1),
          t && !isNaN(q.y)
            ? ((q.opacity = c),
              i[this.isNew ? "attr" : "animate"](q),
              (this.isNew = !1))
            : i.attr("y", -9999);
    },
    destroy: function () {
  ...
  va.prototype = {
    ...
    defaultLabelFormatter: function () {
      ...
      g === v &&
        (g = P(b) >= 1e4 ? y.numberFormat(b, 0) : y.numberFormat(b, -1, v, ""));
      return g;
    },
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              (a.dataMin = H(p(a.dataMin, d[0]), Pa(d))),
    ...
    setTickInterval: function (a) {
      ...
      if (e)
        !a && H(b.min, p(b.dataMin, b.min)) <= 0 && ka(10, 1),
          (b.min = da(Ea(b.min))),
          (b.max = da(Ea(b.max)));
      if (b.range && r(b.max))
    ...
    zoom: function (a, b) {
      ...
      this.allowZoomOutside ||
        (r(c) && a <= H(c, p(e.min, c)) && (a = v),
        r(d) && b >= t(d, p(e.max, d)) && (b = v));
        ...
        if (
          ...
          m(e, function (b) {
            if (
              ...
              T = t(f[b].getLabelSize(), T);
          }),
          a.staggerLines)
        )
          (T *= a.staggerLines), (a.labelOffset = T);
        ...
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({
              ...
              align:
                s.textAlign ||
                { low: "left", middle: "center", high: "right" }[s.align],
            })
    ...
    render: function () {
      var a = this,
        ...
        s = d.lineWidth,
        x,
        p = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin);
      x = a.hasData;
      var B = a.showAxis,
        u,
        q;
      ...
      if (s)
        (x = a.getLinePath(s)),
          a.axisLine
            ? a.axisLine.animate({ d: x })
            : (a.axisLine = c
                .path(x)
                .attr({ stroke: d.lineColor, "stroke-width": s, zIndex: 7 })
                .add(a.axisGroup)),
          a.axisLine[B ? "show" : "hide"]();
      if (h && B)
    ...
    drawCrosshair: function (a, b) {
      var c,
        d = this.crosshair,
        e = d.animation;
      if (!this.crosshair || (r(b) || !p(this.crosshair.snap, !0)) === !1)
        this.hideCrosshair();
      else if (
        (p(d.snap, !0)
    ...
    if (r(b)) {
      ...
      for (
        var d = i.getTime(),
          l = i[Ya](),
          n = i[Xa](),
          o = (F.day + (g ? Wa(i) : i.getTimezoneOffset() * 6e4)) % F.day;
        d < c;
  ...
  Kb.prototype = {
    ...
    getAnchor: function (a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === v && (b = d.pointer.normalize(b)),
  ...
  Va.prototype = {
    ...
    runPointActions: function (a) {
      ...
      if (n && (n !== g || (d && d.isHidden))) {
        if (e && !n.series.noSharedTooltip) {
          ...
          for (c = n.clientX; f--; )
            (h = l[f].clientX),
              (l[f].x !== n.x || h !== c || l[f].series.noSharedTooltip) &&
                l.splice(f, 1);
    ...
    drag: function (a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          f &&
          ((d -= n),
          this.selectionMarker.attr({ width: P(d), x: (d > 0 ? 0 : d) + n }));
        this.selectionMarker &&
          g &&
          ((d = e - o),
          this.selectionMarker.attr({ height: P(d), y: (d > 0 ? 0 : d) + o }));
    ...
    drop: function (a) {
      ...
      if (c)
        J(c.container, { cursor: c._cursor }),
    ...
    destroy: function () {
      ...
      bb ||
        (Y(D, "mouseup", this.onDocumentMouseUp),
        Y(D, "touchend", this.onDocumentTouchEnd));
  ...
  q(y.Pointer.prototype, {
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
      ...
      b < u.min
        ? ((b = u.min), (y = !0))
        : b + s > u.max && ((b = u.max - s), (y = !0));
      y
        ? ((t -= 0.8 * (t - g[j][0])), r || (w -= 0.8 * (w - g[j][1])), c())
        : (g[j] = [t, w]);
      B || ((f[j] = p - o), (f[n] = s));
      f = B ? 1 / m : m;
      e[n] = s;
  ...
  if (O.PointerEvent || O.MSPointerEvent) {
    ...
    cb(Va.prototype, "init", function (a, b, c) {
      ...
      (this.hasZoom || this.followTouchMove) &&
        J(b.container, { "-ms-touch-action": M, "touch-action": M });
    });
    ...
    renderItem: function (a) {
      ...
      if (!m) {
        ...
        a.legendItem = m = c
          ...
          .add(a.legendGroup);
        if (!this.baseline)
          (this.baseline = c.fontMetrics(h.fontSize, m).f + 3 + s),
      ...
      if (e && this.itemX - x + f > (n || b.chartWidth - 2 * j - x - d.x))
        (this.itemX = x), (this.itemY += s + this.lastLineHeight + o);
      ...
      e
        ? (this.itemX += f)
        : ((this.itemY += s + g + o), (this.lastLineHeight = g));
      this.offsetWidth =
        n || t((e ? this.itemX - x - k : f) + j, this.offsetWidth);
    },
    getAllItems: function () {
      var a = [];
      m(this.chart.series, function (b) {
        var c = b.options;
        if (p(c.showInLegend, !r(c.linkedTo) ? v : !1, !0))
          a = a.concat(
  ...
  A.prototype = {
    ...
    layOutTitles: function (a) {
      ...
      if (
        ...
        (c
          ...
          .align(
            q({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f),
            !1,
            "spacingBox"
          ),
    ...
    cloneRenderTo: function (a) {
      ...
      a
        ...
        : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
          ...
          J(b, { position: "absolute", top: "-9999px", display: "block" }),
          b.style.setProperty &&
    ...
    setSize: function (a, b, c) {
      ...
      (za ? lb : J)(d.container, { width: e + "px", height: f + "px" }, za);
      d.setChartSize(!0);
      ...
      if (k)
        f
          ...
          : (this.plotBackground = b
              ...
              .shadow(a.plotShadow));
      if (l)
        h ? h.animate(u) : (this.plotBGImage = b.image(l, s, p, m, r).add());
      q
        ? q.animate({ width: t.width, height: t.height })
        : (this.clipRect = b.clipRect(t));
      if (n)
        g
          ? g.animate(
              g.crisp({ x: s, y: p, width: m, height: r, strokeWidth: -n })
            )
          : (this.plotBorder = b
              .rect(s, p, m, r, 0, -n)
              .attr({
    ...
    isReadyToRender: function () {
      var a = this;
      return (!ba && O == O.top && D.readyState !== "complete") ||
        (ea && !O.canvg)
        ? (ea
            ? Jb.push(function () {
                a.firstRender();
  ...
  R.prototype = {
      ...
      if (
        ...
        if (o && h > o) {
          ...
          if (qa(k)) {
            ...
            if (r)
              for (c = 0; c < h; c++)
                (i = a[c]), (s[c] = i[0]), (x[c] = i.slice(1, r + 1));
            else
      ...
      for (n = 0; n < g; n++)
        (i = h + n),
          j
            ...
            : (b[i]
                ? (k = b[i])
                : a[i] !== v && (b[i] = k = new f().init(this, a[i], d[n])),
              (l[n] = k)),
          (l[n].index = i);
      if (b && (g !== (c = b.length) || j))
        for (n = 0; n < c; n++)
          if ((n === h && !j && (n += g), b[n]))
            b[n].destroyElements(), (b[n].plotX = v);
      this.data = b;
      this.points = l;
    },
    getExtremes: function (a) {
      ...
      for (l = 0; l < d; l++)
        if (
          ((j = c[l]),
          (k = a[l]),
          (i = k !== null && k !== v && (!b.isLog || k.length || k > 0)),
          (j =
    ...
    translate: function () {
      ...
      for (
        ...
        n = m.low;
        var u =
          b && e.stacks[(this.negStacks && B < k ? "-" : "") + this.stackKey];
        if (e.isLog && B !== null && B <= 0) (m.y = B = null), ka(10);
        m.plotX = l = c.translate(q, 0, 0, 0, 1, i, this.type === "flags");
        if (b && this.visible && u && u[q])
          (u = u[q]),
            (B = u.points[this.index + "," + a]),
            (n = B[0]),
            (B = B[1]),
            n === 0 && (n = p(k, e.min)),
            e.isLog && n <= 0 && (n = null),
            (m.total = m.stackTotal = u.total),
            (m.percentage = u.total && (m.y / u.total) * 100),
            (m.stackY = B),
        ...
        m.plotY = n =
          typeof B === "number" && B !== Infinity
            ? H(t(-1e5, e.translate(B, 0, 1, 0, 1)), 1e5)
            : v;
            ...
            if (
              ...
              if (x && (h > 0 || j))
                g.graphic = c.renderer
                  .symbol(i, d - h, e - h, 2 * h, 2 * h, m ? o : l)
                  .attr(a)
                  .add(r);
            }
  ...
  R.prototype.setStackedPoints = function () {
    if (
      ...
      for (r = 0; r < d; r++) {
        ...
        if (!l[m][q])
          n[m] && n[m][q]
            ? ((l[m][q] = n[m][q]), (l[m][q].total = null))
            : (l[m][q] = new Fb(k, k.options.stackLabels, o, q, g));
        m = l[m][q];
        m.points[p] = [m.cum || 0];
        e === "percent"
          ? ((o = o ? h : i),
            j && l[o] && l[o][q]
              ? ((o = l[o][q]),
                (m.total = o.total = t(o.total, m.total) + P(u) || 0))
              : (m.total = da(m.total + (P(u) || 0))))
  ...
  q(A.prototype, {
    addSeries: function (a, b, c) {
      ...
      a &&
        ((b = p(b, !0)),
        G(e, "addSeries", { options: a }, function () {
          d = e.initSeries(a);
          e.isDirtyLegend = !0;
          e.linkSeries();
          b && e.redraw(c);
  ...
  q(R.prototype, {
    addPoint: function (a, b, c, d) {
      ...
      Sa(d, i);
      c &&
        m([g, h, this.graphNeg, this.areaNeg], function (a) {
          if (a) a.shift = k + 1;
        });
      if (h) h.isArea = !0;
      b = p(b, !0);
        ...
        g
          ...
          : (a[f] = a.chart.renderer
              ...
              .attr({
                fill: p(
                  d[2],
                  na(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()
                ),
                zIndex: 0,
              })
              .add(a.group));
  ...
  xa = ja(R, {
    ...
    getPointSpline: function (a, b, c) {
      ...
      if (f && g) {
        ...
        i > a && i > e
          ? ((i = t(a, e)), (k = 2 * e - i))
          : i < a && i < e && ((i = H(a, e)), (k = 2 * e - i));
        k > g && k > e
          ? ((k = t(g, e)), (i = 2 * e - k))
          : k < g && k < e && ((k = H(g, e)), (i = 2 * e - k));
        b.rightContX = j;
        b.rightContY = k;
      }
      c
  ...
  xa = ja(R, {
      ...
      b.grouping === !1
        ...
        : m(a.chart.series, function (b) {
            ...
            if (
              ...
              c.stacking
                ? ((f = b.stackKey), g[f] === v && (g[f] = i++), (h = g[f]))
                : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h);
          });
      var c = H(
    ...
    translate: function () {
      ...
      m(a.points, function (c) {
        ...
        c.tooltipPos = b.inverted
          ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - m - r / 2]
          : [m + r / 2, h + e.pos - b.plotTop];
        r = w(m + r) + l;
        m = w(m) + l;
        r -= m;
        d = P(q) < 0.5;
    ...
    animate: function (a) {
      ...
      if (ba)
        a
          ? ((e.scaleY = 0.001),
            (a = H(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))),
      ...
      a.dlProcessOptions && a.dlProcessOptions(d),
        ...
        m(e, function (e) {
          ...
          if (m && !h) e.dataLabel = m.destroy();
            ...
            if (m)
              if (r(i)) m.attr({ text: i }), (B = !1);
              else {
                if (((e.dataLabel = m = m.destroy()), w))
  ...
  if (N.pie)
    (N.pie.prototype.drawDataLabels = function () {
          ...
          if (M) {
            ...
            for (E = b = 0; !b && I[E]; )
              (b =
                I[E] &&
                I[E].dataLabel &&
                (I[E].dataLabel.getBBox().height || 21)),
                E++;
            if (n > 0) {
              ...
              for (E = 0; E < M; E++) {
                ...
                var S, Q;
                for (Q = 0; Q < u; Q++)
                  (S = P(K[Q] - z[1])), S < c && ((c = S), (L = Q));
                if (L < E && K[E] !== null) L = E;
                else
                  for (
                    u < M - E + L && K[E] !== null && (L = u - M + E);
                    K[L] === null;
            ...
            for (E = 0; E < M; E++) {
              ...
              if (n > 0) {
                if (
                  ...
                  A = H(t(0, c), d.plotHeight);
              } else A = c;
              C = e.justify
                ? o[0] + (J ? -1 : 1) * (q + n)
                : a.getX(A === r - q - n || A === r + q + n ? c : A, J);
              y._attr = { visibility: F, align: z[6] };
              y._pos = {
                x: C + e.x + ({ left: f, right: -f }[z[6]] || 0),
                y: A + e.y - 10,
              };
              y.connX = C;
              y.connY = A;
              if (this.options.size === null)
                (u = y.width),
                  C - u < f
                    ? (G[3] = t(w(u - C + f), G[3]))
                    : C + u > h - f && (G[1] = t(w(C + u - h + f), G[1])),
                  A - b / 2 < 0
                    ? (G[0] = t(w(-A + b / 2), G[0]))
                    : A + b / 2 > i && (G[2] = t(w(A + b / 2 - i), G[2]));
            }
          }
        }
              ...
              m(this.points, function (b) {
                ...
                if ((y = b.dataLabel) && y._pos)
                  (F = y._attr.visibility),
                    ...
                    j
                      ? (j.animate({ d: k }), j.attr("visibility", F))
                      : (b.connector = j =
                          a.chart.renderer
                            .path(k)
                            .attr({
      ...
      (N.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        d[1] !== null
          ? (e = t(H(e, b[2] - t(a[0], a[2])), c))
          : ((e = t(H(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
        e < b[2]
          ? ((b[2] = e),
            this.translate(b),
            m(this.points, function (a) {
  ...
  q(R.prototype, {
    ...
    setVisible: function (a, b) {
      var c = this,
        ...
        h = c.visible;
      f = (c.visible = a = c.userOptions.visible = a === v ? !h : a)
        ? "show"
        : "hide";
